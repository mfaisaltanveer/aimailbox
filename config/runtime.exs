...
#
#     PHX_SERVER=true bin/aimailbox start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :aimailbox, AimailboxWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  #
  #     config :aimailbox, Aimailbox.Mailer,
  ...
  config :aimailbox, :openai_api_key, System.get_env("OPENAI_API_KEY")

  # Configure Cloak encryption
  cloak_key = System.get_env("CLOAK_KEY") || raise """
  environment variable CLOAK_KEY is missing.
  You can generate one by running: mix phx.gen.secret 32 | base64
  """
